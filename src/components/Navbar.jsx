  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-40 transition-all duration-300 ${
        ...
        <div className={`absolute top-0 left-0 right-0 backdrop-blur-3xl bg-white/5 border-b border-white/10 shadow-2xl transform transition-transform duration-500 ease-out ${

          ...
          <div className="min-h-screen bg-black text-white p-2 flex items-center justify-start">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a
                  href="#Contact"
                  className="bg-yellow-400 text-black px-8 py-4 rounded-lg hover:bg-yellow-500 transition-all duration-300 font-medium text-center"
                >
                  Contact Me
                </a>
              </div>
              ...
              <div className="w-full lg:w-[45%] backdrop-blur-2xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-300 text-lg leading-relaxed">
                    I’m an 18-year-old tech enthusiast with a passion for
                    software development and music. Self-driven and always eager
                    to learn. I taught myself to code at 12. Currently building Lancelot, a
                    SaaS app for task and project management, and Trustlinc, a
                    peer-to-peer delivery platform. I’ve also
                    created websites for small businesses to help them grow
                    their online presence—one of which you can find in my
                    projects. Basically, I’m just doing what I love.
                  </p>

                  <p className="text-gray-400 text-base leading-relaxed">
                    When I'm not coding, you'll probably find me singing
                  </p>
                </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 p-4 max-w-5xl mx-auto">
            <div className="bg-black-400 p-4 rounded w-[100px] mx-auto">
              ...
              >
                <path
                  fill="currentColor"
                  d="m7 2l1 1v2H4v1h2L5 7H3V4h4M2 1l1-1h3v3H2v3L1 5V2h4V1"
                />
              </svg>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8 px-4">
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 mb-4">
                    This the Portfolio Website I Built For Myself.
                  </p>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 mb-4">
                    A saas Application for managing tasks and projects.
                  </p>
                  <a
                    href="https://my-expo-app-six.vercel.app/"
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 mb-4">
                    A tool for the project team of a company - Atlantic Fluids
                    and Integrated Services Limited - to help them manage their
                    workflows efficiently.
                  </p>
                  <a
                    href="https://profis-fleet-forge.vercel.app/"
                    className="text-blue-500 hover:underline"
                  >
                    View Project
                  </a>
              ...
              <div className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  <h2 className="text-xl font-semibold mb-2">
                    Novoi Auto Detailing
                  </h2>
                  <p className="text-gray-600 mb-4">
                    A website i built for Novoi, an Auto Detailing business to
                    help showcase their business and allow customers book their
                    services
                  </p>
                  <a
                    href="https://novoi-site.vercel.app/"
                    className="text-blue-500 hover:underline"
                  >
                    View Project
                  </a>
